...
REPO_NAME: process.env.REPO_NAME || "SYED-MD",
BOT_NAME: process.env.BOT_NAME || "SYED-MD",
DESCRIPTION: process.env.DESCRIPTION || "SYED MD PAKISTANI POWERFULL WHATSAPP BOT",
OWNER_NUMBER: process.env.OWNER_NUMBER || "923376539373",
OWNER_NAME: process.env.OWNER_NAME || "SYEDMD Official",
ST_SAVE: process.env.ST_SAVE || "SYED-MD-STATUS-SERVER",
BIO_TEXT: process.env.BIO_TEXT || "SYED-MD-BY-SYED ABDUL WAHAB BUKHARI-OFFICIAL",
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*`STATUS SEEN BY KIRA-MD`* _*POWERD BY*_ *SYED MD Official Whtsapp Bot*",
FOOTER: process.env.FOOTER || "SYED-MD",
COPYRIGHT: process.env.COPYRIGHT || "*㋛ SYED-MD BY ABDUL WAHAB-MD OFFICIAL*",
VERSION: process.env.VERSION || "9.0.0",
NEWSLETTER: process.env.NEWSLETTER || "120363348739987203@newsletter",
WA_CHANNEL: process.env.WA_CHANNEL || "https://whatsapp.com/channel/0029Vb7Vb2Y8F2pDqm0Bfy0z",
INSTA: process.env.INSTA || "https://www.instagram.com/bukhari.syedabdulwahab/?utm_source=qr&r=nametag",
