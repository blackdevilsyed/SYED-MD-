...
async (conn, mek, m, { from }) => {
    try {
        ...
        const ownerName = 'syedMD Official'; // Replace this with the owner's name
        const organization = 'SYED CODERS'; // Optional: replace with the owner's organization
        ...
        await conn.sendMessage(from, {
            ...
            contextInfo: {
                mentionedJid: [ownerNumber.replace('+923376539373', '') + '+923376539373@s.whatsapp.net'], // Mention the owner
...
┃
┃ 👨‍💻  *Owners :-* SYED ABDUL WAHAB BUKHARI MD Official 🇵🇰 
┃
┃ 🧬 *Version :-* ${bot.VERSION}
┃
*⦁⦂⦁*━┉━┉━┉━┉━┉━┉━┉━⦁⦂⦁
